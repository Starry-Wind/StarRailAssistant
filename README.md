...
1.安装最新版本的[Python](https://www.python.org/)(安装时记得勾选Add Python to PATH)

2.游戏语言为**简体中文**，按键配置皆为默认，灵敏度皆为默认值

3.脚本只支持PC端，如果你的电脑分辨率为2560\*1440，请将游戏分辨率调为1920\*1080（窗口化）<br>
...
7.程序运行期间，**请勿移动**键盘及鼠标，如果移动了极有可能造成**偏离**或**撞墙**的问题
