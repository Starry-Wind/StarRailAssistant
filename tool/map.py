...
class map:
    ...
    def auto_map_2_4(self):
        ...
        self.calculated.click_target(
            'temp\\map_2-4.jpg', 0.98)

        self.calculated.click_target(
            'temp\\map_2-4_point_1.jpg', 0.98)

        self.calculated.click_target(
            'temp\\map_2-4_point_2.jpg', 0.98)
        ...
        # 开始寻路
        time.sleep(5)
        self.calculated.auto_map("map_2-4_1")

        pyautogui.keyDown("m")
        pyautogui.keyUp("m")
        time.sleep(1)
        self.calculated.click_target(
            'temp\\map_2-4_point_3.jpg', 0.98)

        self.calculated.click_target(
            'temp\\transfer.jpg', 0.98)

        time.sleep(3)
        self.calculated.auto_map("map_2-4_2")
