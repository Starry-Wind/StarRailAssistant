...
***你現在可以使用tools目錄下的record_v7.2.py自行錄製地圖路徑，包你走到滿意 XD***
...
1.安裝最新版本的[Python](https://www.python.org/)(安裝時記得勾選Add Python to PATH)

2.遊戲語言為**簡體中文**，按鍵配置皆為默認，靈敏度皆為默認值

3.腳本只支持PC端，如果你的電腦分辨率為2560\*1440，請將游戲分辨率調為1920\*1080（窗口化）<br>
...
7.程序運行期間，**請勿移動**鍵盤及鼠標，如果移動了極有可能造成**偏離**或**撞牆**的問題
