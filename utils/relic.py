...
class Relic:
    ...
    stats_name = np.array([
        [_("命值"), _("生命"), _("生命值")], [_("击力"), _("攻击"), _("攻击力")], [_("防御"), _("防御"), _("防御力")], 
        [_("命值"), _("生命"), _("生命值%")], [_("击力"), _("攻击"), _("攻击力%")], [_("防御"), _("防御"), _("防御力%")],
        [_("度"), _("速度"), _("速度")], [_("击率"), _("暴击"), _("暴击率")], [_("击伤"), _("爆伤"), _("暴击伤害")], [_("命中"), _("命中"), _("效果命中")], [_("治疗"), _("治疗"), _("治疗量加成")],
        [_("理"), _("物理"), _("物理属性伤害")], [_("火"), _("火伤"), _("火属性伤害")], [_("冰"), _("冰伤"), _("冰属性伤害")], [_("雷"), _("雷伤"), _("雷属性伤害")], [_("风"), _("风伤"), _("风属性伤害")], 
        [_("量"), _("量子"), _("量子属性伤害")], [_("数"), _("虚数"), _("虚数属性伤害")], 
        [_("抵抗"), _("效果抵抗"), _("效果抵抗")], [_("破"), _("击破"), _("击破特攻")], [_("恢复"), _("能力"), _("能量恢复效率")]
        ], dtype=np.str_)
